...
const DISTRICTS = {
    ...
    '7':  ['Aksu','Alanya','Demre','Döşemealtı','Elmalı','Finike','Gazipaşa','Gündoğmuş','İbradı','Kaş','Kemer','Kepez','Konyaaltı','Korkuteli','Kumluca','Manavgat','Muratpaşa','Serik'],
    ...
    '73': ['Beytüşşebap','Cizre','Güçlükonar','İdil','Merkez','Silopi','Uludere'],
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    citySelect.addEventListener('change', () => {
        ...
        if (cityCode && DISTRICTS[cityCode]) {
            const districts = [...DISTRICTS[cityCode]].sort((a, b) => a.localeCompare(b, 'tr'));
    ...
    searchBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            if (allPharmacies.length === 0) {
                ...
                const sortedDistricts = Array.from(currentDistricts).sort((a, b) => a.localeCompare(b, 'tr'));
                populateDistricts(sortedDistricts);

                // Önceden seçili ilçe sonuçlarda varsa koru
                if (previousDistrict && previousDistrict !== 'all' && currentDistricts.has(previousDistrict)) {
        ...
        pharmacies.forEach(p => {
            ...
            card.innerHTML = `
                ...
                <div class="card-actions">
                    ...
                    <a href="${mapUrl}" target="_blank" class="btn-outline">
